...
namespace Weather.WeatherService {
    ...
    public interface WeatherSoap {
        ...
        Weather.WeatherService.GetWeatherInformationResponse GetWeatherInformation(Weather.WeatherService.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetWeatherInformation", ReplyAction="*")]
        System.Threading.Tasks.Task<Weather.WeatherService.GetWeatherInformationResponse> GetWeatherInformationAsync(Weather.WeatherService.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Weather.WeatherService.ForecastReturn GetCityForecastByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<Weather.WeatherService.ForecastReturn> GetCityForecastByZIPAsync(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Weather.WeatherService.WeatherReturn GetCityWeatherByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<Weather.WeatherService.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP);
    }
    ...
    public partial class GetWeatherInformationResponse {
        ...
        public Weather.WeatherService.WeatherDescription[] GetWeatherInformationResult;
        
        public GetWeatherInformationResponse() {
        }
        
        public GetWeatherInformationResponse(Weather.WeatherService.WeatherDescription[] GetWeatherInformationResult) {
            this.GetWeatherInformationResult = GetWeatherInformationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WeatherSoapChannel : Weather.WeatherService.WeatherSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WeatherSoapClient : System.ServiceModel.ClientBase<Weather.WeatherService.WeatherSoap>, Weather.WeatherService.WeatherSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Weather.WeatherService.GetWeatherInformationResponse Weather.WeatherService.WeatherSoap.GetWeatherInformation(Weather.WeatherService.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformation(request);
        }
        
        public Weather.WeatherService.WeatherDescription[] GetWeatherInformation() {
            Weather.WeatherService.GetWeatherInformationRequest inValue = new Weather.WeatherService.GetWeatherInformationRequest();
            Weather.WeatherService.GetWeatherInformationResponse retVal = ((Weather.WeatherService.WeatherSoap)(this)).GetWeatherInformation(inValue);
            return retVal.GetWeatherInformationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Weather.WeatherService.GetWeatherInformationResponse> Weather.WeatherService.WeatherSoap.GetWeatherInformationAsync(Weather.WeatherService.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformationAsync(request);
        }
        
        public System.Threading.Tasks.Task<Weather.WeatherService.GetWeatherInformationResponse> GetWeatherInformationAsync() {
            Weather.WeatherService.GetWeatherInformationRequest inValue = new Weather.WeatherService.GetWeatherInformationRequest();
            return ((Weather.WeatherService.WeatherSoap)(this)).GetWeatherInformationAsync(inValue);
        }
        
        public Weather.WeatherService.ForecastReturn GetCityForecastByZIP(string ZIP) {
            return base.Channel.GetCityForecastByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<Weather.WeatherService.ForecastReturn> GetCityForecastByZIPAsync(string ZIP) {
            return base.Channel.GetCityForecastByZIPAsync(ZIP);
        }
        
        public Weather.WeatherService.WeatherReturn GetCityWeatherByZIP(string ZIP) {
            return base.Channel.GetCityWeatherByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<Weather.WeatherService.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP) {
